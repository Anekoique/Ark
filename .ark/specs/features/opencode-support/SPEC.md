...
- 2026-07-15 `codeagent-cli-support`: `PLATFORMS` registry grows to 4. CodeAgent CLI uses the same `description`-only YAML frontmatter format as OpenCode for commands and the same `AGENTS.md` managed-block sharing pattern.
